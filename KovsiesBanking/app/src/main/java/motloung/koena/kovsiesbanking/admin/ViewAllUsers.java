...
public class ViewAllUsers extends AppCompatActivity {
    ...
    private void handleItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        Intent intent = new Intent(ViewAllUsers.this, Advice.class);
        ...
        builder.setTitle("Delete user")
                ...
                .setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(deleted){
                            Toast.makeText(ViewAllUsers.this, "User deleted Successfully", Toast.LENGTH_SHORT).show();
                        }else{
                ...
                .setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(ViewAllUsers.this, "Deletion cancelled", Toast.LENGTH_SHORT).show();
                    }
                });
